...
for(let currentPic of picArray) {
  let article = document.createElement('article');
  article.className="card";
  let h2 = document.createElement('h2');
  h2.appendChild(document.createTextNode(currentPic.title));
  let figure = document.createElement('figure');
  {
    let img = document.createElement('img');
    img.src = currentPic.image.medium;
    img.alt = currentPic.title;
    let figCaption = document.createElement('figcaption');
    figCaption.appendChild(document.createTextNode(currentPic.caption));
    figure.appendChild(img);
    figure.appendChild(figCaption);
  }
  let p = document.createElement('p');
  p.appendChild(document.createTextNode(currentPic.description));
  ...
  article.addEventListener('click', function(evt) {
    ...
    img.src = currentPic.image.large;
    img.alt = currentPic.title;
  });
